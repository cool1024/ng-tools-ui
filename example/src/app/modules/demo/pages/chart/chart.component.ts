...
export class ChartComponent implements OnInit {
    ...
    randomData() {
        ...
        this.baseChartData.data = <{ datasets: any[], labels: string[] }>JSON.parse(JSON.stringify(this.baseChartData.data));
        ...
        this.bubbleChartData.data = <{ datasets: any[], labels: string[] }>JSON.parse(JSON.stringify(this.bubbleChartData.data));
    }
